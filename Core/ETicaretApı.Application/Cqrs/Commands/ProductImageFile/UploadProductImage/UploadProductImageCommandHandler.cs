...
namespace ETicaretApı.Application.Cqrs.Commands.ProductImageFile.UploadProductImage
{
    public class UploadProductImageCommandHandler : IRequestHandler<UploadProductImageCommandRequest, UploadProductImageCommandResponse>
    {
        ...
        public async Task<UploadProductImageCommandResponse> Handle(UploadProductImageCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            await _productImageFileWriteRepository.AddRangeAsync(result.Select(r => new ETicaretApı.Domain.Entities.ProductImageFile
            {
                FileName = r.fileName,
                Path = r.pathOrContainerName,
                Storage = _storageService.StorageName,
                Products = new List<ETicaretApı.Domain.Entities.Product>() { product }
            }).ToList());
